...
export class GrpcController {
    ...
    async createTransaction(data: Transaction, metadata: Metadata, call: ServerUnaryCall<any, any>): Promise<Transactions> {
        return this.transactionService.createTransaction(data as CreateTransaction)
    }

    @GrpcMethod('TransactionService', 'ListTransaction')
    async listTransactions(data: CheckTransactions, metadata: Metadata, call: ServerUnaryCall<any, any>): Promise<any> {
    ...
    async queryTransaction(data: CheckTransactions, metadata: Metadata, call: ServerUnaryCall<any, any>): Promise<BalanceResponse> {
